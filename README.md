...
2. [es6新特性，使用过那些方法](#js2)
3. [Map、Object、Set有什么区别](#map)
4. [判断类型的方法有哪些](#js4)
5. [闭包](#js5)
6. [js事件循环、宏任务和微任务，执行顺序有差别，定时器与异步函数的优先级，setTimeout(fn, 0)原理](#js6)
7. [promise、generator、async await](#js7)，promise有几种状态
8. [箭头函数与普通函数的区别](#js8)
9. [== 和 === 区别](#js9)
10. [密码必须匹配一个大写一个小写字母，至少6位数字 ，正则思路应该 如何 考虑和设计](#js10)
11. [react router 如何做到单页面刷新（实现），例如你修改路由路径，并不会造成页面重新刷新是如何做到的，关键点是 h5 histroy和hash router](#js11)
12. [你如何做浏览器缓存 ，例如你给资源文件加了hash码 和版本号，但index.html文件可能还是使用了之前的缓存文件，你应该如何解决，关键字强缓存和弱缓存](#js12)
13. [JS模块话原理（AMD和CMD，import和export）](#js13)
15. [domContentLoad与onload区别](#js15)
16. [判断数据类型的方法](#js16)
17. [ajax实现原理](#js17)
18. [js的执行机制](#js18)
19. [数组去重]
20. [js作用域]
21. [http是否有了解，说一下http1.0 http1.1 http2.0]
22. [undefault与null区别]
22. [怎么获取相同的symbol]
23. [js类型]
...
3. ##### <span id="map">Map、object、Set、Array有什么区别
   ...
   1. Object 都有自己的原型，原型链上的键名有可能和你自己在对象上的设置的键名产生冲突。
...
9. ##### <span id="component">封装过那些组件，需要考虑什么问题
